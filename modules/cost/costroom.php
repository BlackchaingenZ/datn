                    ...
                    ?>
                            <tr>
                                ...
                                <td class="" style="width: 100px; height: 50px;">
                                    <a href="<?php echo getLinkAdmin('cost', 'editcostroom', ['id' => $item['id']]); ?>" class="btn  btn-sm" style="margin-right: 9px;"><i class="fa fa-edit"></i> </a>
                                    <a href="<?php echo getLinkAdmin('cost', 'deletecost', ['id' => $item['id']]); ?>" class="btn  btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa không ?')"><i class="fa fa-trash"></i> </a>
                                </td>
                            </tr>
                        <?php endforeach;
                    else: ?>
