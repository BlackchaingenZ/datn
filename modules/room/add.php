    ...
    <div class="container">
            ...
            <div class="box-content">
                <form action="" method="post" class="row" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <div class="col-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row ckfinder-group">
                                    ...
                                    <div class="col-1">
                                        <button type="button" class="btn  btn-sm choose-image"><i class="fa fa-upload"></i></button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <a style="margin-right: 20px " href="<?php echo getLinkAdmin('room') ?>" class="btn "><i class="fa fa-arrow-circle-left"></i> Quay lại</a>
                    <button type="submit" class="btn "><i class="fa fa-edit"></i> Thêm phòng</button>
                            </div>
                    </div>
                </form>
