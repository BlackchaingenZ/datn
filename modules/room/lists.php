...
<div class="container-fluid">
    ...
    <div>
            ...
            <a href="<?php echo getLinkAdmin('room', 'add') ?>" class="btn " ><i class="fa fa-plus"></i> Thêm mới </a>
            <a href="<?php echo getLinkAdmin('room', 'lists'); ?>" class="btn "><i class="fa fa-history"></i> Refresh</a>
            ...
            <a href="<?php echo getLinkAdmin('room', 'import'); ?>" class="btn"><i class="fa fa-upload"></i> Import</a>
            <a href="<?php echo getLinkAdmin('room', 'export'); ?>" class="btn "><i class="fa fa-save"></i> Xuất Excel</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="image__room">
                                <img src="<?php echo _WEB_HOST_ADMIN_TEMPLATE; ?>/assets/img/apartment.pngg" class="image__room-img" alt="">
                            </div>
                        </td>
                        ...
                        <td class="">
                            <a href="<?php echo getLinkAdmin('room','edit',['id' => $item['id']]); ?>" class="btn " ><i class="fa fa-edit"></i> </a>
                            <a href="<?php echo getLinkAdmin('room','delete',['id' => $item['id']]); ?>" class="btn " onclick="return confirm('Bạn có chắc chắn muốn xóa không ?')"><i class="fa fa-trash"></i> </a>
                        </td>                
