...
<div class="container">
    ...
    <div class="box-content">
        <form action="" method="post" class="row" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="col-5">
                ...
                <div class="form-group">
                    ...
                    <div class="row ckfinder-group">
                        ...
                        <div class="col-1">
                            <button type="button" class="btn  choose-image"><i class="fa fa-upload"></i></button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
            <a href="<?php echo getLinkAdmin('tenant', 'lists'); ?>" class="btn "><i class="fa fa-arrow-circle-left"></i> Quay lại</a>
                <button type="submit" class="btn "><i class="fa fa-edit"></i> Thêm khách</button>
            </div>
        </form>
    </div>
</div>
